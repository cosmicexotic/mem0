...
def main():
    ...
    parser.add_argument("--dataset_name", type=str, default="longmemeval_example", help="Dataset name")
    ...
    if args.technique_type == "mem0":
        if args.method == "add":
            memory_manager = MemoryADD(data_path=f"evaluation/dataset/{args.dataset_name}.json", is_graph=args.is_graph)
